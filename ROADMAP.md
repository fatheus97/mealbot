...
SHIPPED**; next: prompt redesign → allergen screen → UI) and **Growth phase 2
...
schema+compat (**✅ #283**) → reference-layer encoding (**✅ #285**) → prompt → allergen screen → UI. If it pans out, it changes what the whole Growth push is
