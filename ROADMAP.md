...
1. **Complete the product, THEN open registration.** The launch engineering is
   ...
   reference layer is researched — `docs/dietary-reference.md` — and the backend
   is now COMPLETE: schema+compat #283 → reference layer #285 → prompt #288 →
   allergen screen #291 all shipped; **only the multi-select UI (slice 5)
   remains** to turn it on) and a **landing
