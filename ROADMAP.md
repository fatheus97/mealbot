...
prompt #288 SHIPPED**; next: deterministic allergen screen → UI) and **Growth
phase 2
...
schema+compat (**✅ #283**) → reference-layer encoding (**✅ #285**) → prompt (**✅ #288**) → allergen screen → UI. If it pans out, it changes what the whole Growth push is
