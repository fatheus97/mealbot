...
7. **Cheap product wins** (added 2026-07-20) — small items that improve the
   ...
   salt on every list), **shopping list export/check-off** (S–M), **"repeat this week"** (S–M, drives
...
**If you want something small instead of/alongside growth** — pantry staples, the
highest daily-felt-improvement-to-effort item, **shipped 2026-07-24 (#273)**; the
next-cheapest wins are **shopping-list export/check-off** (S–M) and **"repeat this
week"** (S–M). The **admin-dashboard polish** (Admin & operations 4b) and the
