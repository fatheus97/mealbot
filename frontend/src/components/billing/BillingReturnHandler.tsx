 ...
 * `/?billing=success` (or `?billing=cancel`); we strip the marker so a reload
 * can't re-trigger, and on success re-sync the profile — twice, since the
 * subscription webhook can land a beat after the browser returns. Renders nothing.
 */
